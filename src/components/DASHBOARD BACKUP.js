      ...
      >
        ...
        {selectedEvent && (
          <>
            ...
            >
              For successfully attending a Shadowascientist event:
            </Title>
            <Text
              style={{
                fontFamily: 'Merriweather',
        ...
        >
          Achievement Level: <strong>{achievement.level}</strong>
        </Text>
        ...
        >
          Total Events Attended: <strong>{totalAttended}</strong>
        </Text>
      </Card>
    </div>
  );
  ...
  if (isMobile) {
    return (
      <div style={{ padding: 16 }}>
        ...
        <Swiper spaceBetween={10} slidesPerView={1}>
          <SwiperSlide>{jobShadowingWidget}</SwiperSlide>
